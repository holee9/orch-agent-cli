...
| 파일 | 대상 독자 | 언어 | 목적 |
|------|-----------|------|------|
| `README.md` | 인간 개발자 | 한국어 | 시스템 전체 개요 및 운영 가이드 (단일 진실 원본) |
| `AGENTS.md` | 모든 AI 에이전트 | 영어 | 에이전트 공통 규칙 (task claim, 보고서 형식, 금지 사항) |
| `CLAUDE.md` | Claude Code | 영어 | Claude Code 역할 및 단계별 프로토콜 |
| `CODEX.md` | Codex CLI | 영어 | Codex CLI 역할 및 단계별 프로토콜 |
| `GEMINI.md` | Gemini CLI | 영어 | Gemini CLI 역할 및 단계별 프로토콜 |
| `multi-ai-orchestration-implementation-plan-v2.md` | 인간 개발자 | 한국어 | 상세 설계 참고 문서 |
...
- 에이전트 문서(`AGENTS.md`, `CLAUDE.md`, `CODEX.md`, `GEMINI.md`) 구조 변경
...
에이전트 지시 파일(`AGENTS.md`, `CLAUDE.md`, `CODEX.md`, `GEMINI.md`)은 다음 원칙을 따릅니다:
