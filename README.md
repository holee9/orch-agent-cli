...
```bash
bash /path/to/orch-agent-cli/scripts/run_agent.sh codex /path/to/my-target-project
```
...
```bash
bash /path/to/orch-agent-cli/scripts/run_agent.sh gemini /path/to/my-target-project
```
